...
[<img alt="build status" src="https://img.shields.io/github/actions/workflow/status/RazrFalcon/xmlparser.git/ci.yml?branch=main&style=for-the-badge" height="20">](https://github.com/RazrFalcon/xmlparser.git/actions?query=branch%3Amain)
