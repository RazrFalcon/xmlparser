...
test!(declaration_err_01, "<?xml encoding='UTF-8' version='1.0'?>",
    Token::Error("invalid token 'Declaration' at 1:1 cause expected 'v' not 'e' at 1:7".to_string())
);
...
test!(declaration_err_05, "<?xml version='1.0' yes='true'?>",
    Token::Error("invalid token 'Declaration' at 1:1 cause expected '?' not 'y' at 1:21".to_string())
);

test!(declaration_err_06, "<?xml version='1.0' encoding='UTF-8' standalone='yes' yes='true'?>",
    Token::Error("invalid token 'Declaration' at 1:1 cause expected '?' not 'y' at 1:55".to_string())
);

test!(declaration_err_07, "\u{000a}<?xml\u{001d}\u{000a}\u{0000}&jg'];",
    Token::Error("invalid token 'Processing Instruction' at 2:2 cause expected '?' not '\u{001d}' at 2:6".to_string())
);

test!(declaration_err_08, "<?xml \t\n ?m?>",
    Token::Error("invalid token 'Declaration' at 1:1 cause expected 'v' not '?' at 2:2".to_string())
);
...
test!(declaration_err_10, "<?xml \t\n m?>",
    Token::Error("invalid token 'Declaration' at 1:1 cause expected 'v' not 'm' at 2:2".to_string())
);
